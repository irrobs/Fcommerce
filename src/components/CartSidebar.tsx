...
export default function CartSidebar({
  ...
  return (
    <div
      ...
      } flex flex-col fixed z-40 top-0 right-0 bg-white h-full w-1/3 border-l-2 border-primary py-4 px-3 text-primary font-bold translate-x-full duration-500 ease-out `}
    >
      <button
